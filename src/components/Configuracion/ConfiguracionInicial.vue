<template>
    <section class="container">
        ...
        <div class="is-centered" v-if="mostrarIniciar">
            ...
            <b-button type="is-primary" icon-left="play" @click="iniciar">
                Iniciar
            </b-button>
            <ul>
...
export default {
    ...
    methods: {
        iniciar(){
            ...
            .catch(() => {
                this.cargando = false
                this.$toast({ message: 'Error al crear tablas. Verifica el servidor.', type: 'is-danger' })
            })
        },
        ...
        onDatosRegistrado(datos){
            ...
            .catch(() => {
                this.cargando = false
                this.$toast({ message: 'Error al registrar datos.', type: 'is-danger' })
            })
        },
        ...
        onUsuarioRegistrado(datos){
            ...
            .catch(() => {
                this.cargando = false
                this.$toast({ message: 'Error al registrar usuario.', type: 'is-danger' })
            })
        },
    }
}
