                ...
                <div class="column is-12">
                    <div class="box" style="border-top: 4px solid #f14668;">
                        ...
                        >
                            ...
                            <b-table-column field="stockMinimo" label="Stock mínimo" v-slot="props">{{ props.row.stockMinimo }}</b-table-column>
                            <b-table-column field="acciones" label="" v-slot="props">
                                <b-button tag="router-link" :to="'/editar-insumo/' + props.row.id" type="is-primary" size="is-small" icon-left="pen">Editar y reabastecer</b-button>
                            </b-table-column>
                        </b-table>
                    </div>
                </div>
